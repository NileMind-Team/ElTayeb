      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
        <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
          <div className="flex-shrink-0">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white flex items-center justify-center font-semibold text-base sm:text-lg md:text-xl border-2 border-[#8B4513]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-1 sm:space-y-2 text-gray-700 dark:text-gray-300 text-sm sm:text-base">
              <div className="flex items-center gap-2">
                <FaMapMarkerAlt className="text-[#5B2703] flex-shrink-0 text-xs sm:text-sm" />
                <span className="truncate">{branch.address}</span>
              </div>
              <div className="flex items-center gap-2">
                <FaEnvelope className="text-[#5B2703] flex-shrink-0 text-xs sm:text-sm" />
                <span className="truncate">{branch.email}</span>
              </div>
              <div className="flex items-center gap-2">
                <FaClock className="text-[#5B2703] flex-shrink-0 text-xs sm:text-sm" />
                <span>
              ...
              {branch.city && (
                <div className="flex items-center gap-2">
                  <FaCity className="text-[#5B2703] flex-shrink-0 text-xs sm:text-sm" />
                  <span>{branch.city.name}</span>
                </div>
              )}
              {branch.phoneNumbers && branch.phoneNumbers.length > 0 && (
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  <FaPhone className="text-[#5B2703] flex-shrink-0 text-xs sm:text-sm" />
