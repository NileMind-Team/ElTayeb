    ...
    >
      <div className="bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200/50 dark:border-gray-600/50 shadow-lg sticky top-4 sm:top-6">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          ...
          <button
            onClick={onCancel}
            className="text-gray-500 dark:text-gray-400 hover:text-[#5B2703] transition-colors duration-200 flex-shrink-0 ml-2"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <div>
            ...
            <div className="relative group">
              <FaBuilding className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="text"
                name="name"
                value={formData.name}
                ...
                required
                className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg sm:rounded-xl pr-9 pl-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
          ...
          <div>
            ...
            <div className="relative group">
              <FaEnvelope className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="email"
                name="email"
          ...
          <div>
            ...
            <div className="relative group">
              <FaMapMarkerAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="text"
                name="address"
          ...
          <div>
            ...
            <div className="relative group">
              <FaGlobe className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="url"
                name="locationUrl"
            ...
            <div>
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                >
                  <span className="flex items-center gap-2">
                    <FaCity className="text-[#5B2703]" />
                    {formData.cityId
                    ...
                    >
                      {cities.map((city) => (
                        <li
                          ...
                          className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] dark:hover:from-gray-500 dark:hover:to-gray-400 cursor-pointer text-gray-700 dark:text-gray-300 transition-all text-sm sm:text-base border-b border-gray-100 dark:border-gray-500 last:border-b-0 text-right"
                        >
                          {city.name}
                        </li>
                      ))}
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            <div>
              ...
              <div className="relative group">
                <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
                <input
                  type="time"
                  name="openingTime"
          ...
          <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={onCancel}
              className="flex-1 py-2.5 sm:py-3 border-2 border-[#5B2703] text-[#5B2703] dark:text-[#8B4513] dark:border-[#8B4513] rounded-lg sm:rounded-xl font-semibold hover:bg-[#5B2703] dark:hover:bg-[#8B4513] hover:text-white transition-all duration-300 text-sm sm:text-base"
            >
              إلغاء
            </motion.button>
            <motion.button
