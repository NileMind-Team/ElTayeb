        ...
        <div className="grid grid-cols-1 gap-2 sm:gap-3">
          <div>
            ...
            <div className="relative group">
              <FaPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-xs" />
              <input
                type="text"
                name="phone"
                value={phoneNumber.phone}
                onChange={handlePhoneInputChange}
                className="w-full border border-gray-200 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg pr-9 pl-3 py-2 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm"
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm"
              >
                <span className="flex items-center gap-2">
                  <FaPhone className="text-[#5B2703] text-xs" />
                ...
                >
                  <FaChevronDown className="text-[#5B2703] text-xs" />
                </motion.div>
              </button>
                  ...
                  >
                    {[
                      ...
                      <li
                        ...
                        className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] dark:hover:from-gray-500 dark:hover:to-gray-400 cursor-pointer text-gray-700 dark:text-gray-300 transition-all text-sm border-b border-gray-100 dark:border-gray-500 last:border-b-0 text-right"
                      >
                        {type.label}
                      </li>
                    ))}
          ...
          <div className="flex items-center justify-center gap-2 py-2">
            ...
            >
              <input
                ...
                className={`w-3 h-3 text-[#5B2703] bg-gray-100 border-gray-300 rounded focus:ring-[#5B2703] focus:ring-1 ${
                  phoneNumber.type !== "Mobile"
          ...
          <motion.button
            ...
            className={`py-2 rounded-lg font-semibold transition-all duration-300 text-sm flex items-center justify-center gap-2 ${
              phoneNumber.phone.trim()
                ? "bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white hover:shadow-lg"
          ...
          {phoneNumbers.map((phone, index) => (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                <FaPhone className="text-[#5B2703] text-xs sm:text-sm" />
