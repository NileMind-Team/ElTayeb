...
const AuthLayout = forwardRef(
  (
    ...
    return (
      <div
        className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 relative font-sans overflow-hidden transition-colors duration-300`}
        dir="rtl"
      >
        ...
        {!showWelcome && !isProcessingGoogle && (
          <button
            onClick={onBack}
            className="fixed top-6 left-6 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md hover:bg-[#5B2703] hover:text-white rounded-full p-3 text-[#5B2703] dark:text-gray-300 border border-[#5B2703]/30 dark:border-gray-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 min-h-[600px]">
            ...
            {!isProcessingGoogle && (
              <motion.div
                ...
                className="lg:col-span-1 bg-gradient-to-br from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-800 dark:to-gray-700 rounded-l-3xl p-8 flex flex-col transition-colors duration-300"
              >
                {/* Brand Content */}
                <div className="space-y-6 mb-8">
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight text-right">
                    مرحباً بك في{" "}
                    <span className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] bg-clip-text text-transparent">
                      ElTayeb
                    </span>
                  </h1>
                ...
                <div className="flex flex-col gap-3 flex-1 justify-center">
                  <motion.button
                    ...
                    className={`flex items-center gap-4 px-6 py-4 rounded-xl font-semibold text-lg transition-all duration-300 ${
                      activeTab === "login"
                        ? "bg-white dark:bg-gray-800 text-[#5B2703] dark:text-[#8B4513] shadow-lg border border-[#5B2703]/20 dark:border-[#8B4513]/30"
                        : "text-gray-600 dark:text-gray-400 hover:text-[#5B2703] dark:hover:text-[#8B4513] hover:bg-white/50 dark:hover:bg-gray-700/50 border border-transparent"
                    }`}
                  >
                    <div
                      className={`w-2 h-8 rounded-full ${
                        activeTab === "login"
                          ? "bg-[#5B2703] dark:bg-[#8B4513]"
                ...
                <div className="mt-6 mb-6">
                  <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-3 bg-gradient-to-br from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-800 dark:to-gray-700 text-gray-500 dark:text-gray-400">
                        أو تابع باستخدام
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex justify-center mt-4">
                  <div className="flex items-center space-x-2 rtl:space-x-reverse">
                    <div className="w-3 h-3 bg-[#5B2703] dark:bg-[#8B4513] rounded-full animate-bounce"></div>
                    <div
                      className="w-3 h-3 bg-[#8B4513] dark:bg-[#5B2703] rounded-full animate-bounce"
                      style={{ animationDelay: "0.2s" }}
                    ></div>
                    <div
                      className="w-3 h-3 bg-[#5B2703] dark:bg-[#8B4513] rounded-full animate-bounce"
