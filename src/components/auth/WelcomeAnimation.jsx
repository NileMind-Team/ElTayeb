      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] p-6 text-center">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <div className="p-8 space-y-6 text-center">
              ...
              <motion.div
                ...
                className="h-1 bg-gradient-to-r from-[#5B2703] to-[#8B4513] rounded-full"
              />
            </div>
          </motion.div>
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-[#5B2703]/5 to-[#8B4513]/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-[#8B4513]/5 to-[#5B2703]/5 rounded-full blur-3xl"></div>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
