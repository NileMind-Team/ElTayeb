  ...
  return (
    ...
    >
      <div className="text-center mb-2">
        <h2 className="text-2xl font-bold bg-gradient-to-r from-[#5B2703] to-[#8B4513] bg-clip-text text-transparent">
          إنشاء حساب جديد
        </h2>
        <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
          انضم إلى ElTayeb وابدأ رحلتك
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="relative group">
            <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-3">
              <FaUser className="text-[#5B2703] dark:text-[#8B4513] text-lg transition-all duration-300 group-focus-within:scale-110" />
            </div>
            <input
              type="text"
              name="firstName"
              ...
              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-10 pl-3 py-3.5 outline-none focus:ring-2 focus:ring-[#5B2703] dark:focus:ring-[#8B4513] focus:border-transparent transition-all duration-200 group-hover:border-[#5B2703]/50 dark:group-hover:border-[#8B4513]/50 text-sm text-right"
            />
          </div>
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaEnvelope className="text-[#5B2703] dark:text-[#8B4513] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            type="email"
            name="email"
            ...
            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-12 pl-4 py-3.5 outline-none focus:ring-2 focus:ring-[#5B2703] dark:focus:ring-[#8B4513] focus:border-transparent transition-all duration-200 group-hover:border-[#5B2703]/50 dark:group-hover:border-[#8B4513]/50 text-right"
          />
        </div>

        <div className="relative group">
          <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
            <FaPhone className="text-[#5B2703] dark:text-[#8B4513] text-lg transition-all duration-300 group-focus-within:scale-110" />
          </div>
          <input
            type="tel"
            name="phoneNumber"
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pr-12 pl-12 py-3.5 outline-none focus:ring-2 focus:ring-[#5B2703] dark:focus:ring-[#8B4513] focus:border-transparent transition-all duration-200 group-hover:border-[#5B2703]/50 dark:group-hover:border-[#8B4513]/50 text-right"
          />
      ...
      <div className="bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-800 dark:to-gray-700 p-3 rounded-xl border border-[#8B4513]/30 dark:border-gray-600 space-y-2 transition-colors duration-300">
        <p className="text-sm font-semibold text-[#5B2703] dark:text-[#8B4513] text-right">
          متطلبات كلمة المرور:
        </p>
