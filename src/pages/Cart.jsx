...
export default function Cart() {
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#5B2703] dark:text-[#8B4513] font-bold text-base sm:text-lg">
          السعر حسب الطلب
        </div>
      );
    }
    ...
    if (product.hasDiscount) {
      return (
        <>
          ...
          <span className="text-[#5B2703] dark:text-[#8B4513] font-bold text-base sm:text-lg">
  ...
  const formatPriceInModal = (product) => {
    if (product.basePrice === 0) {
      return (
        <span className="text-base sm:text-xl font-bold text-[#5B2703]">
          السعر حسب الطلب
        </span>
      );
    }
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className="text-[#5B2703] dark:text-[#8B4513] text-sm font-semibold hover:underline flex items-center gap-1"
          >
        ...
        <div className="bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl border border-[#5B2703]/30 dark:border-gray-600 p-4">
              ...
              <div
                ...
                ${
                  selectedAddress?.isDefaultLocation
                    ? "bg-[#5B2703] dark:bg-[#8B4513] border-[#5B2703] dark:border-[#8B4513]"
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 flex items-center justify-center px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300">
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300">
        {/* Phone Input Modal */}
        {showPhoneInputModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[80] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaPhone className="text-[#5B2703] text-xl" />
              ...
              <div className="mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#5B2703] focus:border-transparent"
                    dir="ltr"
                  />
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {loadingProfile ? (
                    <>
        ...
        {showMissingInfoModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[70] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaInfoCircle className="text-[#5B2703] text-xl" />
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white">
                    معلومات ناقصة
                  </h3>
                </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
                  مواصلة التسوق
                </button>
              </div>
        ...
        {showNotesModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaStickyNote className="text-[#5B2703] text-xl" />
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white">
                    تعليمات إضافية
                  </h3>
                </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full h-40 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#5B2703] focus:border-transparent resize-none"
                  dir="rtl"
                  maxLength={500}
                  autoFocus
                />
                              ...
                              return (
                                <motion.button
                                  ...
                                  className={`w-full p-2 rounded-md sm:rounded-lg border-2 transition-all duration-200 flex items-center justify-between ${
                                    isSelected
                                      ? "border-[#5B2703] bg-amber-50 dark:bg-amber-900/20"
                                ...
                                >
                                  <div className="flex items-center gap-1">
                                    ...
                                    {isSelected && (
                                      <FaCheck className="text-[#5B2703] text-xs" />
                                    )}
                                  </div>
                ...
                <div
                  ...
                  className={`w-full rounded-lg sm:rounded-xl p-3 sm:p-4 text-center transition-all duration-300 mb-4 sm:mb-5 lg:mb-6 cursor-pointer ${
                    itemNotes
                      ...
                      : "bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 border-2 border-dashed border-amber-300 dark:border-amber-600 hover:border-solid hover:border-amber-400 dark:hover:border-amber-500"
                  }`}
                  dir="rtl"
                >
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
                  ...
                  <div className="flex items-center justify-between w-full md:w-auto gap-3 sm:gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center bg-white dark:bg-gray-700 rounded-lg p-1 shadow">
                        ...
                        >
                          <FaMinus className="text-[#5B2703] text-xs" />
                        </button>
                        ...
                        <button
                          ...
                          className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 flex items-center justify-center rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                        >
                          <FaPlus className="text-[#5B2703] text-xs" />
                        </button>
                      </div>
                    </div>
                    <div className="text-base sm:text-lg lg:text-xl font-bold text-[#5B2703]">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 w-full md:w-auto">
                    ...
                    <motion.button
                      ...
                      className="flex-1 md:flex-none px-4 py-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                    >
                      {updatingCart ? (
                        <>
                          <div className="animate-spin rounded-full h-4 w-4 border-t-2 border-b-2 border-white"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#5B2703] dark:text-gray-300 hover:bg-[#5B2703] dark:hover:bg-[#8B4513] hover:text-white transition-all duration-300 shadow-lg"
              >
            ...
            <div className="text-right self-end sm:self-auto">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#5B2703] dark:text-[#8B4513]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              >
                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                  <FaShoppingCart
                    className="text-[#5B2703] dark:text-[#8B4513] sm:w-6 sm:h-6"
                    size={18}
                  />
                ...
                <div className="space-y-3 sm:space-y-4">
                  <AnimatePresence>
                    {cartItems.length === 0 ? (
                      <div className="text-center py-8 sm:py-12 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#5B2703]/30 dark:border-gray-600">
                        ...
                        <button
                          onClick={() => navigate("/")}
                          className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all text-sm sm:text-base"
                        >
                          تصفح المنتجات
                        </button>
                      </div>
                      ...
                      cartItems.map((item, index) => (
                        <motion.div
                          ...
                          className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#5B2703]/30 dark:border-gray-600 transition-colors duration-300 hover:shadow-lg cursor-pointer group"
                          ...
                          <div className="flex gap-3 sm:gap-4 w-full sm:w-auto sm:flex-1">
                            <div className="relative">
                              ...
                              {item.hasDiscount &&
                                !item.isPriceBasedOnRequest && (
                                  <div className="absolute -top-2 -right-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-2 py-1 rounded-lg text-xs font-bold shadow-lg">
                                    خصم{" "}
                                    {toArabicNumbers(
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="mb-1 sm:mb-2">
                                <div className="flex items-center gap-2">
                                  <h3 className="font-bold text-gray-800 dark:text-white text-base sm:text-lg group-hover:text-[#5B2703] transition-colors">
                                    {item.name}
                                  </h3>
                                  <FaInfoCircle className="text-[#5B2703] opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                              </div>
                              ...
                              {item.prepTime && (
                                <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-2">
                                  <FaClock
                                    className="text-[#5B2703] dark:text-[#8B4513]"
                                    size={12}
                                  />
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1 sm:gap-2 bg-white dark:bg-gray-700 rounded-lg sm:rounded-xl p-1 sm:p-2 shadow-lg">
                              <button
                                ...
                                className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-md sm:rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 text-[#5B2703] dark:text-[#8B4513]"
                              >
              ...
              >
                ...
                <div className="mb-4 sm:mb-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div
                      className={`p-4 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border-2 cursor-pointer hover:shadow-lg transition-all duration-300 ${
                        deliveryType === "delivery"
                          ? "border-[#5B2703] dark:border-[#8B4513]"
                          : "border-[#5B2703]/30 dark:border-gray-600"
                      }`}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <FaMapMarkerAlt className="text-[#5B2703] text-lg" />
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <FaStore className="text-[#5B2703] text-lg" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {loadingBranches ? (
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base cursor-pointer"
                      >
                        <span className="flex items-center gap-2">
                          <FaStore className="text-[#5B2703] dark:text-[#8B4513]" />
                        ...
                        >
                          <FaChevronDown className="text-[#5B2703] dark:text-[#8B4513]" />
                        </motion.div>
                      </button>
                          ...
                          >
                            {branches.map((branch) => (
                              <li
                                ...
                                className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] dark:hover:from-gray-600 dark:hover:to-gray-500 cursor-pointer text-gray-700 dark:text-gray-300 transition-all text-sm sm:text-base border-b border-gray-100 dark:border-gray-600 last:border-b-0"
                              >
                                {branch.name}
                              </li>
                            ))}
                    ...
                    >
                      ...
                      {loadingAreas ? (
                        ...
                        <div className="relative">
                          ...
                          >
                            <span className="flex items-center gap-2">
                              <FaMapMarkerAlt className="text-[#5B2703] dark:text-[#8B4513]" />
                              {selectedArea
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-lg sm:rounded-xl dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#5B2703] focus:border-transparent resize-none h-32"
              dir="rtl"
              maxLength={500}
            />
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                {/* User Info */}
                <div className="mb-4 sm:mb-6">
                  <div className="bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-[#5B2703]/30 dark:border-gray-600">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-[#5B2703] dark:bg-[#8B4513] rounded-full flex items-center justify-center">
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-600 pt-3 sm:pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#5B2703] dark:text-[#8B4513] text-lg sm:text-xl md:text-2xl">
                      ...
                      {deliveryType === "delivery" && selectedArea && (
                        <>
                          ...
                          <div className="flex justify-between text-xs sm:text-sm">
                            ...
                            <span className="font-semibold text-[#5B2703] dark:text-[#8B4513]">
                              {getDeliveryFee().toFixed(2)} ج.م
                            </span>
                          </div>
                        </>
                ...
                <motion.button
                  ...
                  className={`w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 ${
                    ...
                    (deliveryType === "delivery" && !selectedAddress)
                      ...
                      : "bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white hover:shadow-xl"
                  }`}
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => navigate("/")}
                  className="w-full mt-3 sm:mt-4 border-2 border-[#5B2703] dark:border-[#8B4513] text-[#5B2703] dark:text-[#8B4513] py-2 sm:py-3 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base hover:bg-[#5B2703] dark:hover:bg-[#8B4513] hover:text-white transition-all duration-300"
                >
                  مواصلة التسوق
                </motion.button>
              </motion.div>
