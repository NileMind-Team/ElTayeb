            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-white text-black focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                />
              </div>
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <motion.button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base whitespace-nowrap w-full sm:w-auto justify-center"
                >
              ...
              <AnimatePresence>
                {filteredOffers.map((offer, index) => (
                  <motion.div
                    ...
                    className={`bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 hover:shadow-2xl transition-all duration-300 dark:bg-gray-800/90 ${
                      offer.isEnabled &&
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-start justify-between mb-3 sm:mb-4">
                          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                            <div
                              className={`p-3 sm:p-4 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#5B2703]/30 dark:border-gray-500 flex-shrink-0`}
                            >
                              {offer.isPercentage ? (
                                <FaPercent className="text-[#5B2703] dark:text-[#8B4513] text-xl sm:text-2xl" />
                              ) : (
                                <FaMoneyBillWave className="text-[#5B2703] dark:text-[#8B4513] text-xl sm:text-2xl" />
                              )}
                            </div>
                                ...
                                <div>
                                  ...
                                  <p className="font-bold text-blue-600 dark:text-blue-400 text-2xl">
                                    {offer.menuItem?.basePrice === 0 ? (
                                      <span className="text-[#5B2703] dark:text-[#8B4513] font-bold">
                                        حسب الطلب
                                      </span>
                                    ) : (
                                      `ج.م ${
                            ...
                            <div className="flex flex-wrap gap-2">
                              {offer.branchNames
                                ...
                                .map((branchName, index) => (
                                  <span
                                    key={index}
                                    className="px-3 py-1.5 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-lg text-xs font-medium flex items-center gap-1"
                                  >
                      ...
                      <div className="flex flex-col sm:flex-col lg:flex-row gap-2 sm:gap-3 justify-end sm:justify-start mt-4 sm:mt-0">
                        ...
                        <motion.button
                          ...
                          className="flex items-center gap-2 px-4 py-2.5 bg-red-50 text-red-700 hover:bg-red-100 dark:bg-red-900/50 dark:text-red-300 dark:hover:bg-red-800 rounded-lg transition-colors duration-200 text-sm font-medium flex-1 sm:flex-none justify-center"
                        >
              ...
              {!loading && filteredOffers.length === 0 && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleAddNewOffer}
                    className="flex items-center gap-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base mx-auto"
                  >
                ...
                >
                  <div className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 border border-gray-200/50 dark:bg-gray-800/90 dark:border-gray-600 sticky top-4 sm:top-6 transition-colors duration-300">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#5B2703] dark:text-gray-400 dark:hover:text-[#8B4513] transition-colors duration-200 flex-shrink-0 ml-2"
                      >
                    ...
                    >
                      <div>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed text-right"
                          >
                            <span className="flex items-center gap-2 truncate">
                              <FaHamburger className="text-[#5B2703] flex-shrink-0" />
                              {formData.menuItemId
                                ? (() => {
                            ...
                            >
                              {loadingItems ? (
                                <FaSpinner className="text-[#5B2703] animate-spin" />
                              ) : (
                              ...
                              >
                                {loadingItems ? (
                                  <div className="flex items-center justify-center py-4">
                                    <FaSpinner className="text-[#5B2703] animate-spin text-lg" />
                                  ...
                                  <div>
                                    {menuItems.map((item) => (
                                      <div
                                        ...
                                        className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] dark:hover:from-gray-600 dark:hover:to-gray-500 cursor-pointer text-gray-700 dark:text-gray-300 transition-all text-sm sm:text-base border-b border-gray-100 dark:border-gray-600 last:border-b-0 flex flex-col text-right"
                                      >
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            {formData.isPercentage ? (
                              <FaPercent className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm" />
                            ) : (
                              <FaMoneyBillWave className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm" />
                            )}
                            <input
                              type="number"
                              name="discountValue"
                              ...
                              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base text-right"
                              placeholder={
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          ...
                          <div className="relative group">
                            <FaCalendarAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm" />
                            <input
                              type="date"
                              name="startDate"
                              ...
                              onChange={handleInputChange}
                              required
                              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative group">
                            <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm" />
                            <input
                              type="time"
                              name="startTime"
                              ...
                              {branches.map((branch) => (
                                ...
                                >
                                  <input
                                    ...
                                    className="text-[#5B2703] focus:ring-[#5B2703] rounded"
                                  />
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl border border-[#5B2703]/30 dark:border-gray-500">
                        <input
                          type="checkbox"
                          name="isEnabled"
                          checked={formData.isEnabled}
                          onChange={handleInputChange}
                          className="w-4 h-4 text-[#5B2703] bg-gray-100 border-gray-300 rounded focus:ring-[#5B2703] focus:ring-2"
                        />
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2 flex-col sm:flex-row">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={resetForm}
                          className="flex-1 py-2.5 sm:py-3 border-2 border-[#5B2703] text-[#5B2703] rounded-lg sm:rounded-xl font-semibold hover:bg-[#5B2703] hover:text-white transition-all duration-300 text-sm sm:text-base"
                        >
                          إلغاء
                        </motion.button>
                        <motion.button
