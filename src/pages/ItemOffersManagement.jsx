                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
                          <div className="p-3 sm:p-4 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#5B2703]/30 dark:border-gray-500">
                            {offer.isPercentage ? (
                          ...
                          {offer.branchNames && offer.branchNames.length > 0 ? (
                            <div className="flex flex-wrap gap-3">
                              {offer.branchNames.map((branchName, index) => (
                                <span
                                  key={index}
                                  className="px-4 py-2.5 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-xl text-sm font-medium flex items-center gap-2 shadow-md"
                                >
