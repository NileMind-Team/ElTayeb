          ...
          >
            <div className="flex justify-end">
              <motion.button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base whitespace-nowrap"
              >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                              <div className="p-2 sm:p-3 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600 rounded-xl sm:rounded-2xl border border-[#8B4513]/30 dark:border-gray-500">
                                <FaCity className="text-[#5B2703] dark:text-[#8B4513] text-lg sm:text-xl" />
                              </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <FaCity className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#5B2703] text-sm transition-all duration-300 group-focus-within:scale-110" />
                          <input
                            type="text"
                            name="name"
                            value={formData.name}
                            ...
                            required
                            className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
