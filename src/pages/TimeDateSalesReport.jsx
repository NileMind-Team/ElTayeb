...
<title>تقرير المبيعات بالوقت والتاريخ - ElTayeb</title>
<style>
  @media print {
...
<div class="print-header">
  <h1>تقرير المبيعات بالوقت والتاريخ - ElTayeb</h1>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <FaCalendar className="text-[#5B2703] text-xl" />
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaClock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#5B2703]" />
                    <input
                      type="time"
                      value={startTime}
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg px-3 py-2.5 text-right focus:ring-2 focus:ring-[#5B2703] focus:border-transparent outline-none hover:border-[#5B2703] transition-all group"
                    >
                      <div className="flex items-center gap-3">
                          ...
                          <div
                            ...
                            className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-all text-sm border-b dark:border-gray-600 last:border-b-0 ${
                              selectedBranch?.id === branch.id
                                ? "bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-700 dark:to-gray-600"
                                : ""
                            }`}
                          >
                            <span className="text-gray-700 dark:text-gray-300">
