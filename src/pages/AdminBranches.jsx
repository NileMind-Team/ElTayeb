...
export default function AdminBranches() {
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden"
        dir="rtl"
      >
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md hover:bg-[#5B2703] hover:text-white rounded-full p-2 sm:p-3 text-[#5B2703] dark:text-gray-300 border border-[#5B2703]/30 dark:border-gray-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group"
        >
          <FaArrowLeft
            size={14}
