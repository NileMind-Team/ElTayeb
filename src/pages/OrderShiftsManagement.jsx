              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <motion.button
                    ...
                    className="w-full py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white hover:shadow-xl hover:shadow-[#5B2703]/25 cursor-pointer"
                  >
              ...
              <div className="space-y-4">
                        ...
                        <button
                          ...
                          className={`p-3 rounded-lg border transition-all duration-200 ${
                            formData.name === type.value
                              ? "bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white border-transparent"
                              : "bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-[#5B2703] cursor-pointer"
                          }`}
                        >
                          {type.label}
                        </button>
                        ...
                        >
                          <div className="relative group">
                            <input
                              ...
                              required
                              className="w-full border bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg px-4 py-3 outline-none transition-all duration-200 border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-[#5B2703] focus:border-transparent"
                ...
                <div className="flex gap-3 pt-2">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={resetForm}
                    className="flex-1 py-3 border-2 border-[#5B2703] text-[#5B2703] rounded-lg font-semibold hover:bg-[#5B2703] hover:text-white transition-all duration-300"
                  >
                    إلغاء
                  </motion.button>
                  <motion.button
