...
export default function MyOrders() {
  ...
  const showMessage = (type, title, text, options = {}) => {
    if (isMobile() && !options.forceSwal) {
      ...
      Swal.fire({
        ...
        title: title,
        text: text,
        confirmButtonColor: options.confirmButtonColor || "#5B2703",
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300`}
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#5B2703] hover:bg-[#5B2703] hover:text-white transition-all duration-300 shadow-lg dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#5B2703]"
              >
            ...
            <div className="text-right self-end sm:self-auto">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#5B2703]">
                {totalItems} طلب
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border border-gray-200 bg-white rounded-xl px-4 py-3 text-black focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    >
                      <span className="flex items-center gap-2">
                        <FaFilter className="text-[#5B2703]" />
                        {filter === "all"
                          ? "جميع الحالات"
                        ...
                        >
                          {[
                            ...
                            <li
                              ...
                              className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] cursor-pointer text-gray-700 transition-all text-sm sm:text-base border-b border-gray-100 last:border-b-0 dark:hover:from-gray-600 dark:hover:to-gray-500 dark:text-gray-300 dark:border-gray-600"
                            >
                              {item.label}
                            </li>
                          ))}
                        ...
                        {openDropdown === "user" && (
                          ...
                          >
                            <li
                              ...
                              className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] cursor-pointer text-gray-700 transition-all text-sm sm:text-base border-b border-gray-100 dark:hover:from-gray-600 dark:hover:to-gray-500 dark:text-gray-300 dark:border-gray-600"
                            >
                              جميع المستخدمين
                            </li>
                            {loadingUsers ? (
                                  ...
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-600 overflow-hidden flex-shrink-0">
                                      ...
                                      user.imageUrl !==
                                        ...
                                        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#5B2703] to-[#8B4513] text-white text-xs">
                          ...
                          >
                            ...
                            {loadingBranches ? (
                              ...
                              branches.map((branch) => (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#5B2703] to-[#8B4513] flex items-center justify-center text-white text-xs font-bold">
                  ...
                  <div className="block sm:hidden space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white text-black focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    <div className="flex pt-2 sm:pt-0">
                      {(dateRange.start ||
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto px-4 py-3 bg-[#5B2703] text-white rounded-xl hover:bg-[#8B4513] transition-colors duration-200 text-sm sm:text-base whitespace-nowrap flex items-center justify-center gap-2"
                        >
          ...
          {fetchingOrders && (
            ...
            >
              <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#5B2703] mb-4"></div>
            </motion.div>
          )}
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            <div className="flex items-center gap-2">
                              <FaMapMarkerAlt className="text-[#5B2703] flex-shrink-0 w-3 h-3" />
                            ...
                            {order.location?.phoneNumber && (
                              <div className="flex items-center gap-2 sm:ml-4">
                                <FaPhone className="text-[#5B2703] flex-shrink-0 w-3 h-3" />
                        ...
                        <div className="flex flex-row sm:flex-col items-center justify-between sm:items-end lg:items-start gap-3 sm:gap-2 lg:gap-3 pt-3 sm:pt-0 border-t sm:border-t-0 border-gray-100 dark:border-gray-700">
                          <div className="text-left sm:text-right lg:text-left">
                            <div className="text-lg sm:text-xl font-bold text-[#5B2703]">
                              ج.م {finalTotal.toFixed(2)}
                            </div>
                            <div className="text-sm text-gray-600 dark:text-gray-400 hidden sm:block">
                              المبلغ الإجمالي
                              {order.totalDiscount > 0 && (
                                <span className="mr-2 text-green-600 dark:text-green-400 flex items-center gap-1">
                          ...
                          <div className="flex items-center gap-2 text-[#5B2703]">
            ...
            {!fetchingOrders && orders.length === 0 && (
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate("/")}
                  className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-xl font-bold hover:shadow-lg transition-all duration-300 text-sm sm:text-base"
                >
                  ابدأ التسوق
                </motion.button>
              </motion.div>
          ...
          <>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-visible mx-auto relative">
                {/* Modal Header */}
                <div className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] p-5 sm:p-6">
                ...
                <div className="p-5 sm:p-6 relative">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative" ref={statusDropdownRef}>
                        <button
                          ...
                          className="status-dropdown-trigger w-full flex items-center justify-between border border-gray-200 bg-white dark:bg-gray-700 dark:border-gray-600 rounded-xl px-4 py-3 text-black dark:text-white focus:ring-2 focus:ring-[#5B2703] focus:border-transparent transition-all duration-200"
                        >
                          <span className="flex items-center gap-2">
                            <FaFilter className="text-[#5B2703]" />
                            {newStatus
                            ...
                            >
                              {statusOptions.map((option) => (
                                <div
                                  ...
                                  className="px-4 py-3 hover:bg-gradient-to-r hover:from-[#fdf3e8] hover:to-[#f5e1d0] dark:hover:from-gray-600 dark:hover:to-gray-500 cursor-pointer text-gray-700 dark:text-gray-300 transition-all border-b border-gray-100 dark:border-gray-600 last:border-b-0"
                                >
                                  <div className="flex items-center gap-3">
                      ...
                      {newStatus &&
                        newStatus !== selectedOrderForStatus.status && (
                          <motion.div
                            ...
                            className="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg mt-4"
                          >
                            <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <motion.button
                      ...
                      className="flex-1 px-4 py-3 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-xl font-semibold hover:from-[#8B4513] hover:to-[#5B2703] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {updatingStatus ? (
          ...
          <>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col mx-auto my-auto h-full sm:h-auto">
                {/* Modal Header */}
                <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-[#fdf3e8] to-[#f5e1d0] dark:from-gray-800 dark:to-gray-700">
                  <div className="flex items-center gap-3 min-w-0">
                    <FaReceipt className="text-[#5B2703] text-xl sm:text-2xl flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6">
                  {loadingOrderDetails ? (
                    <div className="flex flex-col items-center justify-center h-48 sm:h-64">
                      <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-t-4 border-b-4 border-[#5B2703] mb-4"></div>
                    </div>
                  ) : orderDetails ? (
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                        <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                          <FaUser className="text-[#5B2703] flex-shrink-0" />
                          معلومات العميل
                        </h3>
                      ...
                      {isAdminOrRestaurant &&
                        orderDetails.deliveryFee?.branchId && (
                          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                            <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                              <FaStore className="text-[#5B2703] flex-shrink-0" />
                              معلومات الفرع
                            </h3>
                            <div className="space-y-2 sm:space-y-3">
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#5B2703] to-[#8B4513] flex items-center justify-center text-white font-bold">
                                  {branches
                                    .find(
                                      (b) =>
                                        b.id ===
                      ...
                      {orderDetails.items && orderDetails.items.length > 0 && (
                        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                          <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                            <FaBox className="text-[#5B2703] flex-shrink-0" />
                                    ...
                                    <div className="text-right flex-shrink-0">
                                      ...
                                      {itemAdditions > 0 && (
                                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                          <FaPlusCircle className="inline w-2 h-2 ml-1" />
                                          إضافات: +ج.م{" "}
                                      ...
                                      {itemDiscount > 0 && (
                                        <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                                          <FaTag className="inline w-2 h-2 ml-1" />
                                  ...
                                  <div className="bg-gray-50 dark:bg-gray-800/30 border-t border-gray-100 dark:border-gray-700 p-3 sm:p-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
                                      ...
                                      <div className="col-span-full flex items-center gap-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                                        <FaInfoCircle className="text-[#5B2703] w-3 h-3" />
                                        <span className="text-gray-600 dark:text-gray-400">
                                          السعر النهائي (بعد الخصم والاضافات):
                                        </span>
                                        <span className="font-bold text-[#5B2703]">
                                          ج.م {itemFinalPrice.toFixed(2)}
                                        </span>
                                      </div>
                                    </div>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                          ...
                          {orderDetails.deliveryFee && (
                            <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 pr-3 sm:pr-4">
                              <i>
                                {orderDetails.deliveryFee.areaName} -{" "}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                          <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-sm sm:text-base">
                            <FaInfoCircle className="text-[#5B2703] flex-shrink-0" />
                            معلومات إضافية
                          </h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
                            <div className="flex items-center gap-2">
