...
const Favorites = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fdf3e8] to-[#f5e1d0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300">
            ...
            {favoriteProducts.length === 0 ? (
              ...
              >
                <div className="max-w-md mx-auto">
                  <div className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
                  ...
                  <motion.button
                    ...
                    className="bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white px-8 py-4 rounded-2xl font-bold hover:shadow-2xl transition-all duration-300 flex items-center gap-3 mx-auto text-lg"
                  >
                    <FaHome />
                    ابدأ التسوق الآن
                    <FaArrowRight />
                  ...
                  >
                      ...
                      <div className="p-3">
                        <div className="flex">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="font-bold text-sm text-gray-800 dark:text-gray-200 group-hover:text-[#5B2703] transition-colors line-clamp-1 mb-2"
                    ...
                    <div className="hidden sm:block">
                      ...
                      <div className="p-3 sm:p-4">
                        <h3
                          className="font-bold text-base sm:text-lg text-gray-800 dark:text-gray-200 mb-2 group-hover:text-[#5B2703] transition-colors line-clamp-1"
                          dir={isArabic(product.name) ? "rtl" : "ltr"}
                        >
                          {product.name}
                        </h3>
        ...
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-gradient-to-r from-[#5B2703] to-[#8B4513] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 transition-transform duration-200 no-product-details ${
